...
//! Send host binary data in a row. Length of data array must be larger than cnt
...
//! Simply puts string. It is format text version of @ref API_SendHostString
void API_Putf( char const* fmt, ... ); //!< Print text without time header

//! Transmit log string. It'll automatically append time information in front.
...
//! Export memory location and its size.
