...
//!     sensors.
//! @details
//!              Basically, the distance sensor interface was designed
//!             considering the ARGUS API, which is the driver of the AFBR-S50
//!             sensor used in this project. \n
//!              Instead of using the ARGUS API as it is, the module utilizes a
//!             more abstracted adapter to increase reusability and to be more
//!             flexible in future sensor hardware changes. \n
//!              Hardware management is entirely up to the implementation layer,
//!             so this module does not contain any logic for creating handles.
//!             Handles must be created at program startup and valid at the time
//!             of use.
//! @{
...
//! @brief      Get configuration info from sensor
...
//! @param      Retry
//!              Number of retry chance when measurement fails. \n
